...
export function AdminPage() {
  ...
  function exportSummaryCsv() {
    ...
    downloadCsv(`cerbero_resumen_${fromDateStr}_a_${toDateStr}.csv`, rows);
  }
  ...
  async function exportDetailCsv() {
    ...
    downloadCsv(`cerbero_detalle_${fromDateStr}_a_${toDateStr}.csv`, rows);
    setExporting(null);
  }
  ...
  function exportInspectionCsv() {
    ...
    downloadCsv(`CERBERO_INSPECCION_${fromDateStr}_a_${toDateStr}.csv`, rows, headers);
  }
