...
export async function createCheckIn(
  ...
  const payload = {
    ...
    status: "open",
    workflow_status: shouldCreateAutomaticIncident ? "pending" : "auto",
    flags: {
    ...
    check_in_geo_lat: geo?.lat ?? null,
    check_in_geo_lng: geo?.lng ?? null,
    check_in_geo_accuracy_m: geo?.accuracy ?? null,
    check_in_geo_captured_at: geo?.capturedAt ?? null,
  };
...
export async function createCheckOut(
  ...
  const payload = {
    ...
    status: "closed",
    workflow_status: shouldCreateAutomaticIncident ? "pending" : "auto",
    check_out_geo_lat: geo?.lat ?? null,
    check_out_geo_lng: geo?.lng ?? null,
    check_out_geo_accuracy_m: geo?.accuracy ?? null,
    check_out_geo_captured_at: geo?.capturedAt ?? null,
    flags: {
      ...previousFlags,
      auto_incident: shouldCreateAutomaticIncident,
  ...
  console.log("CHECK OUT PAYLOAD", { entryId, payload });
